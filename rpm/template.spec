...
Summary:        ROS libcurl_vendor package
...
%description
Wrapper around libcurl, it provides a fixed CMake module and an ExternalProject
build of it.
...
%changelog
* Fri Jun 13 2025 Alejandro Hernandez Cordero <alejandro@openrobotics.org> - 3.4.4-1
- Autogenerated by Bloom

* Sat Sep 14 2024 Alejandro Hernandez Cordero <alejandro@openrobotics.org> - 3.4.3-1
- Autogenerated by Bloom
